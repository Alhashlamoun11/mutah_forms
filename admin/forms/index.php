...
<head>
    <?php $page_name="Forms"; include "../../blocks/main_head.php";?>
</head>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td><a href="/admin/forms/edit?id=<?php echo $form['id']?>"><?php echo $form['id']?></a></td>
                                <td><a href="/admin/forms/edit?id=<?php echo $form['id']?>"><?php echo $form['title']?></a></td>
                                <?php if($form['role']==0){?>
                                <td>Public</td>
